...
csv_path = get(
    ENV,
    "SPCE_CSV_PATH",
    "./experiments/double_pendulum/data/double_pendulum_spce_over_training_seeds.csv"
)
...
for (i, train_seed) in enumerate(train_seeds)
    policy_path = "./experiments/double_pendulum/data/double_pendulum_ibis_csmc_ctl_seed$(train_seed).jld2"
