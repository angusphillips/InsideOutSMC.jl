...
io_dir = isempty(config_tag) ? "./experiments/double_pendulum/data" : "./experiments/double_pendulum/data/$(config_tag)"
mkpath(io_dir)

ibis_policy = load(joinpath(io_dir, "double_pendulum_ibis_csmc_ctl_seed$(train_seed).jld2"))["ctl"]
...
writedlm(
    joinpath(io_dir, "double_pendulum_ibis_csmc_trajectory_seed$(train_seed).csv"),
