...
output_dir = isempty(config_tag) ? "./experiments/double_pendulum/data" : "./experiments/double_pendulum/data/$(config_tag)"
mkpath(output_dir)
...
if get(ENV, "SKIP_TRAINED_SEEDS", "0") != "0"
    _existing_policy = joinpath(output_dir, "double_pendulum_ibis_csmc_ctl_seed$(train_seed).jld2")
...
seed_output_path = joinpath(output_dir, "double_pendulum_ibis_csmc_ctl_seed$(train_seed).jld2")
...
evals_csv_path = joinpath(output_dir, "double_pendulum_training_likelihood_evals.csv")
