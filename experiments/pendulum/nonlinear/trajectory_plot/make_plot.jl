...
io_dir = isempty(config_tag) ? "./experiments/pendulum/nonlinear/data" : "./experiments/pendulum/nonlinear/data/$(config_tag)"
mkpath(io_dir)

ibis_policy = load(joinpath(io_dir, "nonlinear_pendulum_ibis_csmc_ctl_seed$(train_seed).jld2"))["ctl"]
...
writedlm(
    joinpath(io_dir, "nonlinear_pendulum_ibis_csmc_trajectory_seed$(train_seed).csv"),
