...
ibis_policy = load("./experiments/pendulum/nonlinear/data/nonlinear_pendulum_ibis_csmc_ctl_seed$(train_seed).jld2")["ctl"]
...
writedlm(
    "./experiments/pendulum/nonlinear/data/nonlinear_pendulum_ibis_csmc_trajectory_seed$(train_seed).csv",
