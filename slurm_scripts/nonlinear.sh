...
#SBATCH --output=/vols/bitbucket/anphilli/policy_learning/slurm_outputs/iosmc_nonlinear%A.out
#SBATCH --error=/vols/bitbucket/anphilli/policy_learning/slurm_outputs/iosmc_nonlinear%A.err
